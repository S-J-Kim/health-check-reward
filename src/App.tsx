...
function App() {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center p-4">
      <ConfettiController trigger={showConfetti} onComplete={handleConfettiComplete} />
      <div className="w-full max-w-6xl">
        ...
        {appState === 'shuffling' && (
          <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="glass-card p-8 md:p-12">
